...
Route::get('/list-peminjam',[anggotaController::class,'ajax']);
Route::get('/nama',[anggotaController::class,'nama']);
Route::get('/list-buku',[anggotaController::class,'buku']);
Route::get('/namabuku',[anggotaController::class,'namabuku']);
